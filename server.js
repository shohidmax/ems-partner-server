...
// [FIX] প্রক্সি এরর সমাধানের জন্য এই লাইনটি যুক্ত করা হয়েছে
...
const apiLimiter = rateLimit({
  ...
  legacyHeaders: false,
  // প্রক্সি ভ্যালিডেশন এরর এড়ানোর জন্য এটি ফলস করা যেতে পারে, 
  // তবে উপরে app.set('trust proxy', 1) দেওয়াই সঠিক সমাধান।
